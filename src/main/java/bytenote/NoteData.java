...
public abstract class NoteData implements Serializable {
	...
	public static NoteData getCurrentData(JFXMain jfxMain) {
		return new V1_0(jfxMain.getRoot().todoPanel.notes, jfxMain.getRoot().doingPanel.notes, jfxMain.getRoot().donePanel.notes, NoteTypes.getTypeMap());
	}
	...
	public abstract void load(JFXMain jfxMain);
	...
	public final static class V1_0  extends NoteData {
		...
		@Override
		public void load(JFXMain jfxMain) {
			jfxMain.getRoot().todoPanel.notes.clear();
			jfxMain.getRoot().todoPanel.addNotes(todoNotes);
			jfxMain.getRoot().doingPanel.notes.clear();
			jfxMain.getRoot().doingPanel.addNotes(doingNotes);
			jfxMain.getRoot().donePanel.notes.clear();
			jfxMain.getRoot().donePanel.addNotes(doneNotes);
