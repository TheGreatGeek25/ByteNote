...
public class Note extends Label implements Serializable {
	...
	public Note(JFXMain jfxMain, int priority, String text, String type) {
		super();
	...
	public Note(JFXMain jfxMain, int priority, String text, String type, NotePanel panel) {
		this(jfxMain, priority, text, type);
		this.panel = panel;
	}
	
	public Note copy(boolean includePanel) {
		if(includePanel) {
			return new Note(jfxMain, priority, noteText, type, panel);
		} else {
			return new Note(jfxMain, priority, noteText, type);
		}
	}
	...
	public boolean getSelected() {
		if(jfxMain.getRoot().infoPanel.note != null) {
			return jfxMain.getRoot().infoPanel.note.equals(this);
		}
		return false;
	}
	...
	public class CMouseListener implements EventHandler<MouseEvent> {
		...
		public void handle(MouseEvent event) {
			jfxMain.getRoot().infoPanel.setNote(Note.this);
		}
	}
